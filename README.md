...
Android Unity Ads integration:
- Game ID: `800358312`
- Banner: `Banner_Android`
- Interstitial: `Interstitial_Android`
- Rewarded: `Rewarded_Android`
- SDK: Unity Ads Android 4.20.0

The app initializes the SDK at startup, preloads interstitial/rewarded ads, renders the banner on Home, and requests an interstitial on content-details screens with a 2-minute cooldown. Ads default to contextual/non-personalized mode until a consent/preferences flow is added. Test placements in Unity dashboard test mode before release.
